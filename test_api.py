...
def client():
    ...
    with app.test_client() as client:
        yield client # Flask provides a test client for simulating requests
...
def test_get_user(client):
    ...
    # First, add a user to ensure there's something to retrieve
    client.post('/users', json={'name': 'Bob Leck', 
                                'email': 'bob@test.com'})
